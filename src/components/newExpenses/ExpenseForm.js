...
const ExpenseForm = (props) => {
  ...
  if (showYN === false) {
    return (
      <div style={'new-expense__controls2', {justifyContent:'center'}}>
        <div className="new-expense__actions_center">
          <button onClick={newBtnOnClickHandler}>Add New Expenses</button>
        </div>
      </div>
    );
  } else {
    return (
      <form onSubmit={onSubmitHandler}>
        ...
        <div className="new-expense__controls2">
          <div className="new-expense__actions">
            <button onClick={cancelBtnOnClickHandler}>Cancel</button>
          </div>
          <div className="new-expense__actions">
